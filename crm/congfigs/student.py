...
class StudentConfig(v1.StarkConfig):
    def display_class(self, obj=None, is_header=False):
        ...
        for class_obj in class_list:
            html.append(class_obj.course.name)
    ...
    list_display = ['customer', 'username', 'password', 'emergency_contract', display_class,display_scores, 'company', 'location',
                    'position', 'salary', 'welfare', 'date', 'memo']